...
$(document).ready(function() {
    ...
    //http://www.w3schools.com/jquery/tryit.asp?filename=tryjquery_sel_not
    /*
     * 
     * <!DOCTYPE html>
<html>
...
$('.coba').contents(':not(.hallo, .cek)').remove();
});
</script>
</head>
<body>
...
</div><table class='cek'><tr> <td> hallo</td><td> hallo</td></tr></table><table class='cessk'><tr> <td> hallo</td><td> hallo</td></tr></table>
<p>Who is your favourisasaste:</p>
</div>
<ul id="choose">
  <li>Goofy</li>
  <li>Mickey</li>
...
http://jsfiddle.net/reigel/r9XQu/
     */
    function h() {
    ...
    $( window ).resize(function() {
        ...
        //var save = $('.table table').detach();
        //$('#freeze_table-div').empty().append(save);
        //$('#freeze_table-div').not('#freeze_table').remove();
        //$('#freeze_table-div').contents(':not(.table)').remove();
        //$('#freeze_table-div').slice(1).remove();
        //$('#freeze_table-div:not(#freeze_table *)').remove();
        //$('#freeze_table-div').contents(':not(#freeze_table)').remove();
        //$('#freeze_table-div').contents(':not(.table .table-bordered .table-hover .table-striped)').remove()
    });
    $('#freeze_table').freezeTableColumns({
            width:       w(),   // required
            height:     h(),   // required
            numFrozen:   1,     // optional jumlah row yg static
            frozenWidth: 80,   //optional panjang row frozen
   ...
   */
    ...
    function ambilDataAbsensi( limitBawah,  limitAtas){
        //jika 1 maka edit
        //set nilai 0
        $("#status_edit").html(0);
        // difungsikan buat gerbang akses pada server side
        ...
        $.ajax({
            type: "POST",
            url: "presensiFingerPrint.ari?xcv="+pintu+"",
            data:dataString,
            dataType: "json",
            //if received a response from the server
            beforeSend: function(){
   ...
   */
    ...
    $( window ).resize(function() {
        ...
        http://gabrieleromanato.name/jquery-filter-and-remove-classes-except-one/
        //var save = $('.table table').detach();
        //$('#freeze_table-div').empty().append(save);
        //$('#freeze_table-div').not('#freeze_table').remove();
        //$('#freeze_table-div').contents(':not(.table)').remove();
        //$('#freeze_table-div').slice(1).remove();
          ...
          $("#freeze_table-div").excludeClass('.table');
